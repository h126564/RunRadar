...
function updateWeatherData() {
    ...
    // Make OpenWeather API call for forecast data
    ...
    fetch(openWeatherApiUrl)
        .then(response => {
            if (!response.ok) {
                throw new Error('OpenWeather API niet te bereiken');
            }
            return response.json();
        })
        .then(data => {
    ...
    // Make OpenWeather API call for current weather data
